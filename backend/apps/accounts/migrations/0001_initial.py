    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_link_code', models.CharField(blank=True, max_length=16)),
                ('telegram_link_code_created_at', models.DateTimeField(blank=True, null=True)),
                ...
                ('otp_request_window_start', models.DateTimeField(blank=True, null=True)),
